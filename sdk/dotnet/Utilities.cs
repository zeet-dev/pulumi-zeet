...
namespace Pulumi.ZeetNative
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ZeetNative.version.txt");
    ...
    internal sealed class ZeetNativeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ZeetNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
