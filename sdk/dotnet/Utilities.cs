...
namespace Pulumi.Zeet
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Zeet.version.txt");
    ...
    internal sealed class ZeetResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ZeetResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
